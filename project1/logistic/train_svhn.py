...
def main():
  ...
  for epoch in range(args.epochs):
    train_acc, train_obj,models = train(train_queue, models, criterion, optimizers)
...
def train(train_queue, models, criterion, optimizers):
  ...
  for step, (input, target) in enumerate(train_queue):
    ...
    for cls,(model,optimizer) in enumerate(zip(models,optimizers)):
      ...
      loss = criterion(logits, target_cls)
      loss.backward()
      optimizer.step()
      sigmoid=nn.Sigmoid()
