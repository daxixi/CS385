...
def main():
  ...
  new=pca.fit_transform(valid_dataset.detach().cpu().numpy())
  ...
  plt.scatter(ttx,tty,label='TP')
  plt.scatter(tfx,tfy,label='FN')
  plt.scatter(ftx,fty,label='FP')
  plt.scatter(ffx,ffy,label='TN')
  plt.legend()
  plt.savefig('vis.png')
  #plt.show()
