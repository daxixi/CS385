...
def main():
  ...
  if args.warm_up:
    ...
    if args.fed_non_iid:
      ...
      if args.client == 10:
        weights_path = 'final/warmup_cifar100.pt'
      elif args.client == 20:
  ...
  dataset = dset.CIFAR100(root='../data', train=True, download=True, transform=train_transform)
  '''
  testds=[]
  ...
  if args.fed_non_iid:
    ...
    if args.non_iid:
      ...
      user_split = even_split(dataset, args.client,100)
