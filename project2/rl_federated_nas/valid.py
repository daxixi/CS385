...
from federated import sample_mask, client_update, fuse_weight_gradient, init_gradient, client_weight_param
...
parser.add_argument('--epochs', type=int, default=5000, help='num of training epochs')
...
def main():
  ...
  utils.load(global_model,file_path)
